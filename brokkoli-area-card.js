          ...
          <form @submit=${this.createPlant}>
            ...
            <div class="form-field">
              ...
              <select id="growth_phase" name="growth_phase" required>
                <option value="seed">${a.TranslationUtils.translateGrowthPhase(this.hass,"seed")}</option>
