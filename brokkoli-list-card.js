          ...
          <form @submit=${this.createPlant}>
            ...
            <div class="form-field">
              ...
              <select id="growth_phase" name="growth_phase" required>
                <option value="seed">${o.TranslationUtils.translateGrowthPhase(this.hass,"seed")}</option>
