...
`},8265:(t,e,i)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.BrokkoliListComponents=void 0;const n=i(4437),a=i(9442),s=i(8598),r=i(2413);e.BrokkoliListComponents=class{static renderHeader(t,e){if(""===t)return n.html``;const i=e?r.TranslationUtils.translateListCard(e,"title"):"Pflanzenübersicht";return n.html`
            <div class="card-header">
                <div class="name">${t||i}</div>
            </div>
        `}static renderToolbar(t,e,i,a,s,o,l,c,d){var u,p,h,m,g,f,v;if(!(null===(u=null==t?void 0:t.multiselect)||void 0===u?void 0:u.enabled)&&!(null===(p=null==t?void 0:t.search)||void 0===p?void 0:p.enabled)&&!(null===(h=null==t?void 0:t.filter)||void 0===h?void 0:h.enabled))return n.html``;const b=d?r.TranslationUtils.translateListCard(d,"filter_close"):"Filter schließen",y=d?r.TranslationUtils.translateListCard(d,"filter"):"Filter",_=d?r.TranslationUtils.translateListCard(d,"multiselect_end"):"Mehrfachauswahl beenden",x=d?r.TranslationUtils.translateListCard(d,"multiselect"):"Mehrfachauswahl",w=d?r.TranslationUtils.translateListCard(d,"search_reset"):"Suche zurücksetzen",$=d?r.TranslationUtils.translateListCard(d,"search_default"):"Suche...";return n.html`
            <div class="toolbar">
        ...
        `}static renderAddPlantButton(t,e){const i=e?r.TranslationUtils.translateListCard(e,"add_plant"):"Neue Pflanze hinzufügen";return n.html`
