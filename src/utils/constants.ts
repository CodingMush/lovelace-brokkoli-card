...
// Tent-specific element options (different from plants)
export const tentElementOptions = [
    { label: 'Header', value: 'header' },
...
// Tent-specific attributes (different from plants)
export const tentAttributes : DropdownOption[] = [
  { label: 'Illuminance', value: 'illuminance' },
  { label: 'Humidity', value: 'humidity' },
  { label: 'CO2', value: 'co2' },
  { label: 'Power Consumption', value: 'power_consumption' },
